...
class VWOMCPServer {
    ...
    registerTools() {
        const tools = [
            ...
            new tools_1.ListProjectsAndEnvironmentsTool(),
            new tools_1.ListFeatureFlagRulesTool(),
            new tools_1.CreateRolloutAndPersonalizeRuleTool(),
            new tools_1.CreateTestingAndMVTRuleTool(),
            new tools_1.GetFeatureFlagRuleTool(),
            new tools_1.ToggleFeatureFlagRuleTool(),
