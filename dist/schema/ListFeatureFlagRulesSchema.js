...
exports.ListFeatureFlagRulesSchema = void 0;
const zod_1 = require("zod");
const constants_1 = require("../constants");
exports.ListFeatureFlagRulesSchema = {
    environmentIdOrKey: zod_1.z.string(),
    featureIdOrKey: zod_1.z.string(),
    limit: zod_1.z.number().max(25).min(1).optional().default(10),
...
//# sourceMappingURL=ListFeatureFlagRulesSchema.js.map