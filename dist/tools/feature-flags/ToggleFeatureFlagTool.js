...
const ToggleFeatureFlagSchema_1 = require("../../schema/ToggleFeatureFlagSchema");
...
class ToggleFeatureFlagTool extends BaseTool_1.BaseTool {
    constructor() {
        ...
        const inputSchema = ToggleFeatureFlagSchema_1.ToggleFeatureFlagSchema;
    ...
    async execute(args) {
        ...
        const response = (0, ResponseMessages_1.formatGenericResponse)(`Feature flag "${args.featureIdOrKey}" toggled successfully. Result: ${JSON.stringify(result, null, 2)}`, args.sdk);
        return {
            content: [
                {
                    type: 'text',
